...
public class ConsoleController{
    ...
    public Song getSongByTitle(@PathVariable String title) {
        System.out.println( "Получена песня:" + title);
        return  mp3PlayerService.SongfindByTitle(title);
    }
    ...
    @Autowired
    public ConsoleController(SongRepository songRepository, Mp3PlayerService mp3PlayerService) {
    ...
    public Song addSong(@RequestBody Song song) {
        ...
        return mp3PlayerService.addSong(song);
    }
